...
class Environment:
    ...
    def __init__(self, all_cooked_time, all_cooked_bw, all_cooked_tiles, all_tile_chunk_video_size,
                 all_cooked_saliency, random_seed=RANDOOM_SEED):
        ...
        self.all_cooked_saliency = all_cooked_saliency
    ...
    def get_video_chunk_size_quality(self, quality_in_fov, quality_out_fov=0, chunk_index=''):
        ...
        Note that then tiles out fov have the same bitrate level, while tiles within fov's bitrate is configured
        according to the fov saliency.

        :param quality_in_fov: np array, video quality set, level from 0~BITRATE_LEVELS-1
